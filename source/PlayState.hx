...
class PlayState extends MusicBeatState
{
	...
	function badNoteCheck(daNote:Note) //WHAT
		{
			...
			if (n0P) noteMiss(0,daNote);
			if (n1P) noteMiss(1,daNote);
			if (n2P) noteMiss(2,daNote);
			if (n3P) noteMiss(3,daNote);
			if (n4P) noteMiss(4,daNote);
			if (n5P) noteMiss(5,daNote);
			if (n6P) noteMiss(6,daNote);
			if (n7P) noteMiss(7,daNote);
			if (n8P) noteMiss(8,daNote);
